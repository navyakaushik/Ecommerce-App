...
import { calculatePercentage, getChartData, getInventories } from "../utils/fefeatures.js";
    ...
    if(myCache.has(key)) 
        ...
        lastSixMonthOrders.forEach((order)=> {
           ...
           getInventories({
            ...
            const modifiedTLatestransaction = latestTransaction.map((i) => ({
                _id: i._id,
                discount: i.discount,
                amount: i.total,
        ...
        stats = {
            ...
            userRatio,
            latestTransaction: modifiedTLatestransaction,
        };
